...
// sendMessageImpl 发送消息实现
func (h *GRPCHandler) sendMessageImpl(ctx context.Context, req *rest.SendLogicMessageRequest) (*rest.SendLogicMessageResponse, error) {
	// 将业务信息添加到context
...
// handleMessageAckImpl 处理消息ACK确认实现
func (h *GRPCHandler) handleMessageAckImpl(ctx context.Context, req *rest.MessageAckRequest) (*rest.MessageAckResponse, error) {
	// 将业务信息添加到context
