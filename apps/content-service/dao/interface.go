...
type ContentDAO interface {
	...
	IncrementLikeCount(ctx context.Context, contentID int64) error
	IncrementCommentCount(ctx context.Context, contentID int64) error
	IncrementShareCount(ctx context.Context, contentID int64) error
